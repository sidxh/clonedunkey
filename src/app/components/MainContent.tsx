        ...
        <div className="max-w-2xl mx-auto lg:max-w-none">
          <div className="flex flex-col md:flex-row md:justify-stretch md:spacing-x-4" style={{ opacity: 1, transform: 'none' }}>
            <div className="w-full">
              <h1 className="font-display text-5xl font-medium tracking-tight text-gray-950 [text-wrap:balance] sm:text-[64px] sm:leading-[72px] font-sans">Seriously Fast API Authentication</h1>
              <p className="mt-6 text-xl text-[#57534E] [text-wrap:balance] sm:leading-[32px]">Unkey is an <span className="font-semibold">open source</span> API authentication and authorization platform for scaling user-facing APIs. Create, verify, and manage low latency API keys in seconds.</p>
            ...
            <div className="mt-4 aspect-w-16 aspect-h-9 lg:hidden">
              <iframe src="https://www.youtube-nocookie.com/embed/-gvpo4SWgG8?si=8n5wIAdTZA7PCgZb" title="Unkey in Five minutes - YouTube" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen={true}></iframe>
            </div>
          </div>
        </div>
      </div>
